...
public class BlockDebitCardSwitchActivity extends AppCompatActivity implements AlertDialogOkListener {
                    ...
                    if (position != 0) {
                        ...
                        if (TrustMethods.isSimAvailable(getApplicationContext()) && TrustMethods.isSimVerified(BlockDebitCardSwitchActivity.this)) {
                            if (NetworkUtil.getConnectivityStatus(BlockDebitCardSwitchActivity.this)) {
                                new LoadDebitCardDetailsAsyncTask(BlockDebitCardSwitchActivity.this, accNo).execute();
                            } else {
    ...
    private void displayREasonDropdown(List<BlockDebitReason> reasonList) {
        ArrayAdapter<BlockDebitReason> adapter = new ArrayAdapter<>(BlockDebitCardSwitchActivity.this, android.R.layout.simple_spinner_item, reasonList);
        adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
